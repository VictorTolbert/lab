...
class CILogViewer {
    ...
    public const LOG_LINE_START_PATTERN = "/((INFO)|(ERROR)|(DEBUG)|(ALL))/";
    public const LOG_DATE_PATTERN = "/(\d{4,}-[\d\-:]{2,})\s([\d:]{2,})/";
    public const LOG_LEVEL_PATTERN = "/^((ERROR)|(INFO)|(DEBUG))/";
     ...
     */
    private $LOG_VIEW_FILE_FOLDER = FCPATH."application/logs/";
    private $LOG_VIEW_FILE_NAME = "logs.php";
    private $LOG_VIEW_FILE_PATH = FCPATH."application/logs/";
