...
class MY_Model extends CI_Model
{
	...
	protected $soft_delete_timestamp_key = null;
	...
	public function delete($id) {
		...
		if ($this->soft_delete) {
			$update_clause = [ $this->soft_delete_key => true ];

			if ($this->soft_delete_timestamp_key) {
				$update_clause[$this->soft_delete_timestamp_key] = date('Y-m-d H:i:s');
			}

			$result = $this->db->update($this->_table, $update_clause);
		} else {
	...
	public function delete_by() {
		...
		if ($this->soft_delete) {
			$result = $this->db->update($this->_table, [ $this->soft_delete_key => true ]);
		} else {
			$result = $this->db->delete($this->_table);
		}
