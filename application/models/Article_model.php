...
class Article_model extends MY_Model
{
	...
	{
		$insert_data = array(
			array('title' => 'First article title'),
			array('title' => 'Another article title'),
			array('title' => 'One more article title'),
			array('title' => 'This article has a title too'),
			array('title' => 'How about this article title'),
		);
