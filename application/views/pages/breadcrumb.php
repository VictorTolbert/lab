			...
			<ol class="flex items-center space-x-4">
				...
				<li>
					<div class="flex items-center">
						...
						<a href="<?= base_url('organizations/1') ?>" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Organization</a>
					</div>
				</li>
				<li>
					<div class="flex items-center">
						...
						<a href="#" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Settings</a>
					</div>
				</li>
			</ol>
		</nav>
