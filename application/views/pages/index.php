...
<main class="flex-1 p-8">
	...
	<section class="mt-8 prose">
		<button type="button" @click="on = !on" :aria-pressed="on.toString()" aria-pressed="true" x-data="{ on: false }" :class="{ 'bg-gray-200': !on, 'bg-primary-600': on }" class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-primary-600 w-11 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
