		...
		<div class="lg:flex lg:items-center lg:justify-between">
			<div class="flex-1 min-w-0">
				...
				<div class="flex flex-col mt-1 sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
					<div class="flex items-center mt-2 text-sm text-primary-200">
						<!-- Heroicon name: briefcase -->
						<svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-primary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
