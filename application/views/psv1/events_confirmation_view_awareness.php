	...
	<form class="form" action="<?php echo base_url();?>form/savevolunteeragreement" method="post">
		...
		<?php echo $this->session->flashdata('msg'); ?>
			<div class="col-sm-10 col-sm-offset-1">
				...
				<div class="top20">
					<p>Thank you for attending the awareness event and expressing your interest to help vulnerable children who are in the foster care system.</p> 

					 <p>We will be in touch soon about the upcoming volunteer orientation event.</p>
