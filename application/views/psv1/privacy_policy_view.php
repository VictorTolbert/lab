...
<?php echo $site_sidebar; ?>
	...
	<div class="col-sm-12 main container">
		<?php if(empty($env_scope) || (!empty($env_scope) && $env_scope != 'frontend')){?>
		<div class="row">
			<ol class="breadcrumb">
				<li>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Promise Serves Privacy Policy</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="panel panel-container">
			<div class="internal-page-nav">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<ul>
						...
						<li>
							<a href="#information-useage">Information Usage</a>
						</li>
						<li>
							<a href="#information-protection">Information Protection</a>
						</li>
						<li>
							<a href="#cookie-useage">Cookie Usage</a>
						</li>
						<li>
							<a href="#3rd-party-disclosure">3rd Party Disclosure</a>
						</li>
						<li>
							<a href="#3rd-party-links">3rd Party Links</a>
						</li>
						<li>
							<a href="#google-adsenses">Google AdSenses</a>
						</li>
						<li>
							<a href="#fair-information-practices">Fair information Practices</a>
						</li>
						<li>
							<a href="#coppa">COPPA</a>
						</li>
						<li>
							<a href="#caloppa">CalOPPA</a>
						</li>
						<li>
							<a href="#contact-info">Our Contact Information</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="col-sm-9 col-xs-12">
				...
				</div><span id='infoCo'></span><br>
				<div class='grayText'>
					<strong>What personal information do we collect from the people that visit our website or app?</strong>
				</div><br>
				<div class='innerText'>
				...
				<div class='innerText'>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To quickly process your transactions.
				</div>
				<div class='innerText'>
				...
				<div class='grayText'>
					<strong><a name="cookie-useage"></a>Do we use 'cookies'?</strong>
				</div><br>
				<div class='innerText'>
				...
				<div class='innerText'>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Send informational updates to our mailing list.
				</div>
				<div class='innerText'>
					<br>
				...
				<div class='innerText'>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Allow users to unsubscribe by using the link at the bottom of each email.
				</div>
				<div class='innerText'>
					<strong><br>
					If at any time you would like to unsubscribe from receiving future emails, you can email us at info@promise686.org.</strong>
				</div>
				<div class='innerText'>
