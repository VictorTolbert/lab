...
<div class="col-sm-12 main container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo  ' Share Volunteers / My Requests';?></li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">My Volunteer Requests</h1>
				<p>This page shows you the pending requests for volunteers that you have made of advocates from other churches.</p>
			</div>
		</div><!--/.row-->
						  ...
						  <tbody>
							  <?php if(isset($lists)){
										foreach($lists AS $list){
											...
											if(!empty($list['subject_url_avatar'])){
												$list_subject['url_avatar']		= $list['subject_url_avatar'];
											}
											if(!empty($list['subject_name_first'])){
												$list_subject['name_first']		= $list['subject_name_first'];
											}
											if(!empty($list['subject_name_last'])){
												$list_subject['name_last']		= $this->website_model->display_format_people_name_last($list['subject_name_last']);
											}
											
											?>
										<tr class="people-<?php echo $list['subject_id_people'];?>">
										  <td class="text-center">
											<?php $this->people_model->display_people_avatar($list_subject);?>
											...
											<div class="dropdown" style="float:none;">
												...
												<ul class="dropdown-menu">
													<li>
														<a href="#bannerformmodal" data-toggle="modal" data-target="#composemessagemodal" class="btn-msg-trigger" data-rids="100">Cancel Request</a>
													</li>
												</ul>
											</div>
											</td>
									...
									?>
								<tr>
									<td colspan="20"><h4 class="text-center">You have no pending volunteer requests.</h4></td>
								</tr>
							<?php }?>
						</tbody>
					</table>
