			...
			?>
				<div class="top40">
					...
					<div class="col-sm-7 col-xs-12">
						...
						<p>To protect the privacy of the family we ask that you fill out the form below and we'll send an email to the family you are referring. That email will have the video you see on this page as well as an invitation link for them to request a care community from their home church or a church near to them.</p>
						<p>While we try to support every family possible please keep in mind that depending on geography and current volunteer strength we may not be able to support this family at this time.</p>
					</div>
				</div>
				<?php }?>
			</div><!--/.row-->
			...
			<div class="row">
				<form class="form-horizontal form-label-left" action="<?php echo base_url();?>needs/saverequestcc" method="post" style="padding: 20px;">
					...
					<fieldset class="top40">
						<legend>Foster Family Info</legend>
						<div class="form-group">
				...
				<fieldset class="top40">
					...
					<div class="form-group">
						<div class="col-sm-6 col-xs-12 col-sm-offset-3">
							...
							<p>By submitting this form I understand that my data will be used only for establishing a care community around the family I'm referring and used in accordance with the terms of this website's <a href="<?=base_url();?>privacy-policy" target="_blank">privacy policy</a>.</p>
				  ...
				  <div class="form-group">
					...
					<input type="hidden" name="need_type" value="cc_refer_family" />
