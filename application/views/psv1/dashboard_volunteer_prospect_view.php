...
<div class="col-sm-12 main container page-dashboard">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Prospect Dashboard</h1>
		</div>
	</div><!--/.row-->
		...
		<div class="column-left col-xs-12 col-sm-12 col-md-4"> 
			...
			<div class="panel panel-container">
				<div class="panel-heading">
					<h2 class="text-center">Upcoming Needs & Events</h2>
				</div>
				<div class="panel-body">
					<div class="row top20"></div>
					<?php 
					if(!empty($community_ids)){
						$upcoming		= $this->dashboard_model->get_dashboard_upcoming_events(array('community_ids' => $community_ids));
						if(!empty($upcoming['html']) && !empty($upcoming['data'])){
							echo $upcoming['html'];
						}else{
							echo '<div class="row top30 text-center" >No upcoming needs or events.</div>';
						}
					}else{
						echo '<div class="row top30 text-center" >No upcoming needs or events.</div>';
					}
					...
					<div class="row top30">
						...
						<div class="col-sm-4 col-sm-offset-4">
							<!-- <a href="#needmodal" data-toggle="modal" data-target="#needmodal" class="btn btn-default btn-md center-block">
