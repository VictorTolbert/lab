...
<div class="col-sm-12 main container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Families 
					...
					?>
					  ...
					  <tbody>
						  <?php if(isset($lists)){
								$arr_already_shown	= array();
									...
									<tr>
										<td class="text-center">
											...
											<?php if($this->security_model->user_has_access(99)){ echo '<p class="text-center">'. $list['id_family'].'</p>'; }?>
											<div class="dropdown" style="float:none;">
												<button class="btn btn-default dropdown-toggle" role="button" data-toggle="dropdown">
													<span class="caret"></span> Actions
												</button>
												<ul class="dropdown-menu">
													<li><a href="<?php echo $cur_link;?>" class="ps_link_load_ui>Edit</a></li>
													...
													<?php }?>
													<?php if(!empty($id_parents[0])){ ?>
														<li><a href="#composemessagemodal" data-toggle="modal" data-target="#composemessagemodal" class="btn-msg-trigger" data-rids="<?php echo implode(',',$id_parents);?>" data-msgslug="email_family_foster_request_update_info">Request Info Update</a></li>
													<?php }?>
										...
										<td style="vertical-align: middle;" class="ps_link_load_ui">
											<?php echo '<a href="'.$cur_link.'">'.$status.'</a>';?>
										</td>
										<td style="vertical-align: middle;" class="ps_link_load_ui">
											<?php echo $list['family_address_zip'];?>
								...
								?>
							<tr>
								<td colspan="20">No familes found. <a href="<?php echo base_url();?>families/list?clear_limiters=1">Try broadening your search.</a></td>
							</tr>
						<?php }?>
					</tbody>
					<?php break;
